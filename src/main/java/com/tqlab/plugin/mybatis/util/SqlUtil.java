...
public final class SqlUtil {
     ...
     * </pre>
     */
    private static final String FOREACH_PATTERN
        = "<(foreach)([\\sa-zA-Z0-9=\"#{}(),_\\-\\\\])*>([\\sa-zA-Z0-9=\"#{}(),_\\-\\\\])*</(foreach)>";

    private static final String SELECT_KEY_PATTERN
        = "<(selectKey)([\\sa-zA-Z0-9=\"#{}(),_\\-\\\\])*>([\\sa-zA-Z0-9=\"#{}(),_\\-\\\\])*</(selectKey)>";
    /**
