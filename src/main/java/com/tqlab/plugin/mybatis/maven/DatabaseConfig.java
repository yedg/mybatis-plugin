...
public class DatabaseConfig {
    ...
    /**
     * @param jdbcUserId the jdbcUserId to set
     */
    ...
    /**
     * @param doSuffix the doSuffix to set
     */
    ...
    /**
     * @param doRootClass the doRootClass to set
     */
    ...
    /**
     * @param generateJdbcConfig the generateJdbcConfig to set
     */
    ...
    /**
     * @param generateSpringConfig the generateSpringConfig to set
     */
    ...
    /**
     * @param generateOsgiConfig the generateOsgiConfig to set
     */
